...
- `PG-HOUSE-001` astrology houses
- `PG-HOUSE-002` 8th house meaning
- `PG-HOUSE-003` 12th house astrology
- `PG-HOUSE-004` 9th house astrology
- `PG-HOUSE-005` 11th house
- `PG-NODE-001` North Node vs South Node
- `PG-NODE-002` north node in scorpio
- `PG-NODE-003` north node in taurus
...
- [x] PG-WC-006 vinicius jr zodiac sign
...
- [x] PG-WC-021 england world cup 2026 astrology -> LIVE https://www.astrologywiki.com/en/wiki/england-world-cup-2026-astrology （球队篇 T2）
- [x] PG-WC-022 james rodriguez birth chart -> LIVE https://www.astrologywiki.com/en/wiki/james-rodriguez-birth-chart （巨蟹）
- [x] PG-WC-023 luis díaz birth chart -> LIVE https://www.astrologywiki.com/en/wiki/luis-diaz-birth-chart （摩羯）
- [x] PG-WC-024 yoane wissa birth chart -> LIVE https://www.astrologywiki.com/en/wiki/yoane-wissa-birth-chart （处女；纽卡/刚果金）
- [x] PG-WC-025 christian pulisic birth chart -> LIVE https://www.astrologywiki.com/en/wiki/christian-pulisic-birth-chart （处女；美国东道主）
...
> 5 篇唯一 EN 全部当日 prod 部署。流程：deep-research 事实预核查 → Opus 4.8 high 作者 → 逐篇修正不可核实断言/星历 → phase2 → preview gate（三维 review + codex 事实门）→ merge → prod 验证。Bruno（vice-captain + Mars 误判）与 Rhaenyra（HotD S3 时效 + authoring park）各经一次门 park 后修复上线。
...
- [x] `PG-CELEB-008` Harry Styles and Zoë Kravitz -> LIVE https://www.astrologywiki.com/en/wiki/harry-styles-and-zo-kravitz （合盘 Aquarius×Sagittarius；codex 6 轮纠错：sextile 非 trine / 60°非120° / 异 modality / 去 Pew 统计；slug 因 ë→zo）
...
## ⚪ 7月2日 (周四) - 待写作
**状态**：`等待输出` (自动补充选题，共 5 篇)
- [x] `PG-CELEB-020` Jaylen Brown birth chart
