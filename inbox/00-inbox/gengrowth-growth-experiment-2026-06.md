...
|---|------|---------|------|----------------------|
| H1 | 品类内存在 ≥ 10 个 KD < 20 + SERP弱的商业/问题意图词 | Day 0 Step 5 完成时 | ✅ **验证通过** — 快速胜利桶 881 条，远超阈值 | < 5 个 → 竞争密度过高或品类过窄，重新评估 |
...
### 词池摘要（Step 5 完成 2026-06-10，去重更新 2026-06-12）

> 原始词库 1,183 条，去重删除 84 条重复词，实际词库 1,099 条。
> 数据来源：关键词主表 v3.3（含 SERP弱度 + Top10最低2站DR均值，更新于 2026-06-12）

| 桶 | 词数 | 备注 |
|----|------|------|
| 趋势词★ | **14** | 发现排名趋势后插队执行 |
| 快速胜利（含★标注） | **803** | 主战场，约 60% 产能；其中 SERP ✅弱 205 个 |
| 长尾词 | **217** | 矩阵执行，约 40% 产能 |
| 战略词 | **59** | 最低优先，全周期 ≤ 5 篇 |
| 跳过★ | 6 | 已标记排除，不生产 |
| **合计（有效词）** | **1,093** | 去重后 1,099 条，减去跳过★6 条 |
