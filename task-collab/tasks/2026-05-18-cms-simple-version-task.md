...
- 产品反馈原文：[[2026-05-14-astrologywiki-product-feedback]]（需求 #1）
- 评审决议：上述反馈文档「💡 评审反馈」段
- Obsidian 模板：`templates/草稿-SEO博客-AIO.md`
- oracle 仓库：`/Users/wzb/code/oracle`
- 关联任务：[[2026-05-18-astrologywiki-landpage-task]]（首页 Featured Articles 读取 .md 后的 article index）
