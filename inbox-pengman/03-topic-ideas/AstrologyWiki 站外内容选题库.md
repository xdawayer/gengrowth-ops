...
source:
  ...
  - [[inbox/00-inbox/topic-cluster-table.csv]]
---

# AstrologyWiki 站外内容选题库

> 这是一个持续追加的灵感库，不是最终生产表。  
...
|---|---|
| Topic | 选题名 / Hook |
| Platform | YouTube / Shorts / TikTok / Pinterest / X / Reddit |
| Theme | Birth Chart / Houses / Aspects / Saturn Return / Astrology Literacy 等 |
| Angle | 教学 / 辟谣 / 图卡 / 故事 / 反思 / 调研 |
| Cluster | 如果能对应到主题集群，就写 cluster_id |
| Entry Point | 用户已知入口，比如 sun sign / zodiac sign / horoscope |
| Natural Next Step | 可自然承接的方向，不一定是链接 |
| Risk | 宿命化 / 过度预测 / 标签化 / 诊断化 / 无 |
| Status | Idea / Draft / Test / Archived |

## 2. 主题总览

### 2.1 入口主题

这类主题适合从泛星座用户进入，特别是只知道自己太阳星座的人。
...
这类主题更适合做成系列内容、图卡和解释型 Shorts。

- [[The 12 Houses as Life Areas]]
- [[Empty Houses Do Not Mean Something Is Missing]]
- [[Planet Sign House Formula]]
- [[What Aspects Mean in Real Life]]
- [[Chart Ruler as a Starting Point]]

### 2.3 解释型主题

这类主题适合把用户常见误解拆开，做 myth-busting 或 FAQ。

- [[Birth Chart Is Not a Destiny Verdict]]
- [[Patterns Not Predictions]]
- [[Reflection Not Diagnosis]]
- [[Saturn Return Without Fear]]
- [[Synastry Is Not Compatibility Math]]

### 2.4 反思型主题

这类主题适合 Pinterest、X、Shorts，也适合未来的 journal prompts。

- [[Moon Sign Journal Prompts]]
- [[Chart to Journal]]
- [[What Does My Moon Sign Need Emotionally]]
- [[What House Questions Confuse You Most]]
- [[Check Your Chart Before You Judge Your Sign]]

### 2.5 热点 / 体育入口

这类主题适合用现实事件做切入点，再回到占星解释与品牌表达。优点是更容易借时效获得曝光，缺点是要严格控制表达边界，避免写成预测或博彩语境。

- [[Lionel Messi’s Cancer Sun]]
- [[Sports Moment as Astrology Hook]]
- [[Current Event + Zodiac Sign]]
- [[Topic Hook: Argentina Win → Messi Cancer Sun]]
...
- [[How to Read Your Birth Chart Without Feeling Overwhelmed]]
- [[Sun, Moon, and Rising: What They Actually Mean]]
- [[The 12 Houses Explained as Life Areas]]
- [[Saturn Return Without Fear: A Self-Reflection Guide]]
- [[Why Your Sun Sign Is Not Your Whole Personality]]
- [[What Transits Can and Cannot Tell You]]
- [[Lionel Messi’s Cancer Sun]]

### 3.2 TikTok

TikTok 首轮先复用 YouTube Shorts，不单独开制作线。这里优先记录能被短视频快速表达、且有高互动潜力的题。

- [[Your Sun Sign Is Not Your Whole Chart]]
- [[The Basics for Reading Your Birth Chart]]
- [[Which House Do You Have Cancer In]]
- [[Why Does My Birth Chart Have Fewer Lines]]
- [[Pick Your Astrologer Wisely]]
- [[One of the Luckiest Placements in Your Chart]]
- [[Lionel Messi’s Cancer Sun]]
...
- [[Birth Chart Cheat Sheet]]
- [[Big Three Quick Card]]
- [[The 12 Houses as Life Areas]]
- [[Aspects FAQ Card]]
- [[Planets in Astrology What How Where]]
- [[Moon Sign Journal Prompts]]

### 3.4 X

适合观点测试、短句 Hook、用户问题收集。

- [[Your Sun Sign Is Only One Sentence]]
- [[Fewer Lines Does Not Mean Less Important]]
- [[Empty Houses Are Not Empty Life]]
- [[Ask Your Biggest Chart Question]]
- [[What House Confuses You Most]]
- [[Lionel Messi’s Cancer Sun]]
...
- [[How Do I Read My Chart Without Getting Lost]]
- [[Do Empty Houses Matter]]
- [[What Does My Chart Ruler Mean]]
- [[How Do I Start With Astrology]]

## 4. 目前值得优先继续看的主题包

### 4.1 Birth Chart Basics

这个主题包适合从 `sun sign / zodiac sign` 过渡到完整星盘，是首轮最稳的入口之一。

可继续扩展：

- Sun sign / Moon sign / Rising
- planet / sign / house
- chart ruler
- why your sign does not always feel accurate

### 4.2 Houses

这是最适合做系列化知识卡和 Shorts 的主题之一。

可继续扩展：

- 12 houses overview
- empty houses
- house meanings in real life
- houses vs signs

### 4.3 Aspects

适合处理“线少”“相位多/少”“hard aspects 是不是坏”等 FAQ。

可继续扩展：

- what aspects mean
- fewer lines in birth chart
- hard aspects vs soft aspects
- aspects as patterns, not verdicts

### 4.4 Saturn Return

适合做“without fear”的解释型内容，也适合对接 calculator 或 guide。

可继续扩展：

- what Saturn Return means
- Saturn Return by age
- why people fear it
- what it can help you notice

### 4.5 热点内容入口

这个主题包对应的是“现实事件 + 占星解释”的入口型内容。它更适合在 X / YouTube Shorts / TikTok 先做测试，再决定是否延伸到更长的视频或站内文章。
...
- 名人当下事件 + 星座切入
- 热点新闻 + 占星 literacy
- 当前事件 + birth chart / self-understanding


### 4.5.1 已制作归档：Harry Kane Leo Sun / England vs DR Congo

- Topic: Harry Kane's Leo Sun under knockout pressure
- Platform: YouTube Shorts / TikTok
- Theme: Current event + Birth Chart / Sun Sign literacy
- Angle: 热点赛事入口 + captain spotlight + Leo symbolism
- Entry Point: England vs DR Congo, Harry Kane, World Cup Round of 32
...
- 太像预测、好运承诺、关系判词的题目，优先降速。
- 只适合做猎奇、但不适合做品牌表达的 Hook，不要直接拿来当长期主线。
- 适合 TikTok 的题，不一定适合 YouTube 轻量视频，反之亦然。
- 一条内容可以没有明确页面链接，但最好知道它是为了导流、互动、调研，还是品牌表达。

## 6. 后续补充建议

如果后面你想把这个选题库再往前推一步，可以分成三张更细的子页：

1. 入口主题库：只放 Sun Sign -> Birth Chart 相关的题。
2. 平台 Hook 库：只放 TikTok / Shorts / Pinterest 的可发布标题。
3. 生产候选库：只放已经能转入正式 production 的题。
